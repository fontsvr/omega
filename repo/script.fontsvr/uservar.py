...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR aqua]script fontsvr[/COLOR]'
BUILDERNAME = 'fontsvr'
EXCLUDES = [ADDON_ID, 'repository.fontsvr']
# Text File with build info in it.
BUILDFILE = 'https://raw.githubusercontent.com/fontsvr/fontsvr.github.io/main/wizard/xml/ajustes_fontsvr.txt'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR white][B]Script[/B][/COLOR] [COLOR aqua]fontsvr[/COLOR]'
