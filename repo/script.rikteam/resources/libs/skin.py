...
def swap_us():
    ...
    if 'false' in response:
        ...
        response = xbmc.executeJSONRPC(query)
        logging.log_notify(CONFIG.ADDONTITLE,
                           '[COLOR {0}]Fuentes Desconocidas:[/COLOR] [COLOR {1}]Activadas[/COLOR]'.format(CONFIG.COLOR1, CONFIG.COLOR2))
        ...
        response = xbmc.executeJSONRPC(query)
        logging.log_notify(CONFIG.ADDONTITLE,
                           '[COLOR {0}]Fuentes Desconocidas:[/COLOR] [COLOR {1}]Desactivadas[/COLOR]'.format(CONFIG.COLOR1, CONFIG.COLOR2))
        logging.log("Unknown Sources Set Settings: {0}".format(str(response)))
