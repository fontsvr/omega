...
def all_with_progress(_in, _out, dp, ignore, title):
    ...
    for item in zin.infolist():
        ...
        line1 = '{0} [COLOR {1}][B][Error:{2}][/B][/COLOR]'.format(title,
                                                                    CONFIG.COLOR2,
                                                                    errors)
        line2 = '[COLOR {0}][B]Archivos:[/B][/COLOR] [COLOR {1}]{2}/{3}[/COLOR] '.format(CONFIG.COLOR2,
                                                                                     CONFIG.COLOR1,
                                                                                     count,
                                                                                     int(nFiles))
        ...
        if item.filename == 'userdata/sources.xml' and CONFIG.KEEPSOURCES == 'true':
            skip = True
        elif item.filename == 'Database/MyVideos119.db' and CONFIG.KEEPMYVIDEOS == 'true':
            skip = True
        ...
        if skip:
            ...
            try:
                ...
                errormsg = "[COLOR {0}]Archivos:[/COLOR] [COLOR {1}]{2}[/COLOR]\n".format(CONFIG.COLOR2,
                                                                                      CONFIG.COLOR1,
                                                                                      file[-1])
    ...
    if dp.iscanceled():
        ...
        logging.log_notify(CONFIG.ADDONTITLE,
                           "[COLOR {0}]Extraccion Cancelada[/COLOR]".format(CONFIG.COLOR2))
        sys.exit()
