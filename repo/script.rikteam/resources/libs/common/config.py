...
class Config:
    ...
    def init_paths(self):
        ...
        self.ESTUARY_DATA = os.path.join(self.ADDON_DATA, 'skin.estuary.stva')
        self.CTOUCH_DATA = os.path.join(self.ADDON_DATA, 'skin.ctouch')
        self.EMBUARY_DATA = os.path.join(self.ADDON_DATA, 'skin.embuary.stva')
        self.STVA_DATA = os.path.join(self.ADDON_DATA, 'script.stva')
