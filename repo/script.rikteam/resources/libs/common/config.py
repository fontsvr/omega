...
class Config:
    ...
    def init_uservars(self):
        ...
        self.ICONTOOLS = uservar.ICONTOOLS if not uservar.ICONTOOLS.endswith('://') else self.ADDON_ICON
        ...
        self.ICONalfa = uservar.ICONREAL if not uservar.ICONREAL.endswith('://') else self.ADDON_ICON
        ...
        self.ICONACE = uservar.ICONACE if not uservar.ICONACE.endswith('://') else self.ADDON_ICON
        self.ICONURL = uservar.ICONURL if not uservar.ICONURL.endswith('://') else self.ADDON_ICON
        self.ICONAPI = uservar.ICONAPI if not uservar.ICONAPI.endswith('://') else self.ADDON_ICON
        self.ICONHDFULL = uservar.ICONHDFULL if not uservar.ICONHDFULL.endswith('://') else self.ADDON_ICON
        self.ICONBUFFER = uservar.ICONBUFFER if not uservar.ICONBUFFER.endswith('://') else self.ADDON_ICON
    ...
    def init_paths(self):
        # Static variables
        self.CLEANFREQ = ['Siempre', 'Diario', '3 dias',
                          'Semanal', 'Mensual']
        ...
        self.EXCLUDE_DIRS = [self.ADDON_ID, 'cache', 'system', 'packages',
                             ...
                             'Backups', 'library', 'cdm', 'archive_cache']
        ...
        self.ALFA_DATA = os.path.join(self.ADDON_DATA, 'plugin.video.alfa')
        self.SILVO_FONTSVR_DATA = os.path.join(self.ADDON_DATA, 'skin.aeon.nox.silvo.fontsvr')
        self.CTOUCH_DATA = os.path.join(self.ADDON_DATA, 'skin.ctouch.fontsvr')
        self.SILVO_DATA = os.path.join(self.ADDON_DATA, 'skin.aeon.nox.silvo')
        self.FONTSVR_DATA = os.path.join(self.ADDON_DATA, 'script.fontsvr')
        self.SHORTCUTS_DATA = os.path.join(self.ADDON_DATA, 'script.skinshortcuts')
        self.TRAKT_DATA = os.path.join(self.ADDON_DATA, 'script.trakt')
        ...
        self.alfaFOLD = os.path.join(self.PLUGIN_DATA, 'alfa')
        ...
        self.MYVIDEOS = os.path.join(self.DATABASE, 'MyVideos119.db')
    ...
    def init_settings(self):
        ...
        self.alfaSAVE = self.get_setting('alfanextsave')
        ...
        self.KEEPMYVIDEOS = self.get_setting('keepmyvideos')
        ...
        self.KEEPalfa = self.get_setting('keepalfa')
        ...
        self.MYBUILDS = os.path.join(self.BACKUPLOCATION, 'Backups')
