...
class Router:
    ...
    def dispatch(self, handle, paramstring):
        ...
        # MENU SECTIONS
        ...
        elif mode == 'urlacestream': 
        	try:
        		xbmcaddon.Addon(id = 'script.module.horus')
        		xbmc.executebuiltin('ActivateWindow(10025,"plugin://script.module.horus/?%3d%3d,return")')
        	except:
        		xbmc.executebuiltin('InstallAddon("script.module.horus")')
        		xbmc.executebuiltin('ActivateWindow(10025,"plugin://script.module.horus/?%3d%3d,return")')
        elif mode == 'urlstream': 
        	try:
        		xbmcaddon.Addon(id = 'plugin.video.alfa')
        		xbmc.executebuiltin('ActivateWindow(10025,"plugin://plugin.video.alfa/?%3d,return")')
        	except:
        		xbmc.executebuiltin('InstallAddon("plugin.video.alfa")')
        		xbmc.executebuiltin('ActivateWindow(10025,"plugin://plugin.video.alfa/?%3d,return")')
        elif mode == 'gbuffer': 
        	try:
        		xbmcaddon.Addon(id = 'script.luar')
        		xbmc.executebuiltin('ActivateWindow(10025,"plugin://script.luar/?")')
        	except:
        	...
        	try:
        		xbmcaddon.Addon(id = 'script.luar')
        		xbmc.executebuiltin('ActivateWindow(10025,"plugin://script.luar/?%3d&quot;,return")')
        	except:
        		xbmc.executebuiltin('InstallAddon("script.luar")')
        		xbmc.executebuiltin('ActivateWindow(10025,"plugin://script.luar/?%3d&quot;,return")')
        elif mode == 'hdfull': 
        	try:
        		xbmcaddon.Addon(id = 'plugin.video.alfa')
        		xbmc.executebuiltin('PlayMedia("plugin://plugin.video.alfa/?%3D,return")')
        	except:
        		xbmc.executebuiltin('InstallAddon("plugin.video.alfa")')
        		xbmc.executebuiltin('PlayMedia("plugin://plugin.video.alfa/?%3D,return")')
        elif mode == 'fmchoose':
            ...
            menu.trakt_menu()
            self._finish(handle)
        elif mode == 'realalfa':  # Save Data -> Keep alfa
            menu.alfa_menu()
            self._finish(handle)
       ...
       # elif mode == 'hidepassword':  # Addon Tools -> Hide Passwords on Keyboard Entry
        ...
        #  CLEANING
            ...
            logging.log_notify("[COLOR {0}]{1}[/COLOR]".format(CONFIG.COLOR1, CONFIG.ADDONTITLE),
                               "[COLOR {0}]Datos reseteados[/COLOR]".format(CONFIG.COLOR2))
        # BACKUP / RESTORE
        ...
        # ADDON INSTALLER
            ...
            plugin = self.params['plugin'] if 'plugin' in self.params else None
        ...
        # alfa
        elif mode == 'savealfa':  # Save alfa Data
            from resources.libs import alfait
            alfait.alfa_it('update', name)
        elif mode == 'restorealfa':  # Recover All Saved alfa Data
            from resources.libs import alfait
            alfait.alfa_it('restore', name)
        elif mode == 'addonalfa':  # Clear All Addon alfa Data
            from resources.libs import alfait
            alfait.alfa_it('clearaddon', name)
        elif mode == 'clearalfa':  # Clear All Saved alfa Data
            from resources.libs import alfait
            alfait.clear_saved(name)
        elif mode == 'authalfa':  # Authorize alfa
            from resources.libs import alfait
            alfait.activate_alfa(name)
            xbmc.executebuiltin('Container.Refresh()')
        elif mode == 'updatealfa':  # Update Saved alfa Data
            from resources.libs import alfait
            alfait.auto_update('all')
        elif mode == 'importalfa':  # Import Saved alfa Data
            from resources.libs import alfait
            alfait.import_list(name)
            xbmc.executebuiltin('Container.Refresh()')
